...
namespace Prescriptions
{
    public class PrescriptionService : IPrescriptionService
    {
        ...
        public async Task<int> AddPrescription(PrescriptionFormModel form, int animalId)
        {
			...
			VeterinarySystem.Data.Domain.Entities.Prescription prescription = new VeterinarySystem.Data.Domain.Entities.Prescription()
            {
                Number = form.Number,
        ...
        {
			VeterinarySystem.Data.Domain.Entities.Prescription? prescription = await data.Prescriptions
        ...
        {
            IQueryable<VeterinarySystem.Data.Domain.Entities.Prescription> query = data.Prescriptions
                .AsNoTracking()
