...
namespace Animal
{
    public class AnimalService : IAnimalService
    {
        ...
        {
			VeterinarySystem.Data.Domain.Entities.Animal animal = new VeterinarySystem.Data.Domain.Entities.Animal()
            {
        ...
        {
			VeterinarySystem.Data.Domain.Entities.Animal? animal = await data.Animals
